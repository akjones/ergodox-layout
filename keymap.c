...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [COLEMAK_MAC] = LAYOUT_ergodox(
        ...
        KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,TO(COLEMAK_LINUX),
    ...
    [COLEMAK_LINUX] = LAYOUT_ergodox(
        ...
        KC_H,KC_N,KC_E,KC_I,KC_O,KC_QUOTE,
        KC_MEH,KC_K,KC_M,KC_COMMA,KC_DOT,KC_SLASH,KC_TRANSPARENT,
        KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,TO(COLEMAK_MAC),
